...
const CodeBlocks = ({
  ...
  return (
    ...
    >
      ...
      {/* Section 2 */}
      <div className="h-fit code-border flex text-[10px] w-[100%] p-2 gap-2 lg:w-[500px] relative border-2 border-transparent">
        {/* add gradient in bg */}
        <div
          className={`absolute ${block == 1 ? "codeblock1" : "codeblock2"}`}
        ></div>
