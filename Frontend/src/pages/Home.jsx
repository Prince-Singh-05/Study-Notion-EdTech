...
const Home = () => {
  return (
    <div>
      {/* Section 1 */}
      <section className="flex relative mx-auto flex-col w-11/12 items-center text-richblack-5 justify-center max-w-maxContent mt-14 gap-8">
        {/* Top Section */}
        ...
        {/* Video section */}
        <div className="my-7 mx-3 shadow-[20px_20px_0px_0px_#fff]">
