...
// check if updateProfile function updates image in backend
	...
	return async (dispatch) => {
		...
		try {
			...
			const userImage = response.data?.updatedUserDetails?.image
				...
				: `https://api.dicebear.com/9.x/initials/svg?seed=${response.data?.updatedUserDetails?.firstName} ${response.data?.updatedUserDetails?.lastName}`;
